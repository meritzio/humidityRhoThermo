...
void Foam::HumidityRhoThermo<BaseThermo>::calculate()
{
    ...
    forAll(this->T_.boundaryField(), patchi)
    {
        ...
        if (pT.fixesValue())
        {
            forAll(pT, facei)
            {
                ...
                const typename BaseThermo::mixtureType::transportMixtureType&
                    transportMixture =
                    this->transportMixture
                    (composition, thermoMixture);
...
template<class BaseThermo>
Foam::HumidityRhoThermo<BaseThermo>::HumidityRhoThermo
(
    const fvMesh& mesh,
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::initialize()
{
    pSatH2O();
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::correct()
{
    if (BaseThermo::debug)
    {
        InfoInFunction << endl;
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::pSatH2O()
{
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::
partialPressureH2O()
{
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::relHumidity()
{
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::waterVapor()
{
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::waterMass()
{
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::updateRho
(
    volScalarField& rho
)
{
...
template<class BaseThermo>
void Foam::HumidityRhoThermo<BaseThermo>::limitMax()
{
